...
file = '2A.GPM.DPR.V9-20211125.20230215-S011727-E024958.050939.V07A.HDF5'
...
eyewall_dist = 45
inner_core_range = np.array([45,250])
...
for i in range(ku_dl_eyewall.shape[0]):
    ...
    slope_dl_eyewall_nw = stats.mstats.linregress(nw_dl_eyewall_warm[i,:],freezing_dl_eyewall[i,:])[0]
    slope_nw_dl_eyewall.append(slope_dl_eyewall_nw)

    slope_dl_eyewall_dm = stats.mstats.linregress(dm_dl_eyewall_warm[i,:],freezing_dl_eyewall[i,:])[0]
    slope_dm_dl_eyewall.append(slope_dl_eyewall_dm)


slope_warm_dl_eyewall = np.asarray(slope_warm_dl_eyewall)
slope_nw_dl_eyewall = np.asarray(slope_nw_dl_eyewall)
slope_dm_dl_eyewall = np.asarray(slope_dm_dl_eyewall)
...
for i in range(ku_dr_eyewall.shape[0]):
    ...
    slope_dr_eyewall_nw = stats.mstats.linregress(nw_dr_eyewall_warm[i,:],freezing_dr_eyewall[i,:])[0]
    slope_nw_dr_eyewall.append(slope_dr_eyewall_nw)

    slope_dr_eyewall_dm = stats.mstats.linregress(dm_dr_eyewall_warm[i,:],freezing_dr_eyewall[i,:])[0]
    slope_dm_dr_eyewall.append(slope_dr_eyewall_dm)


slope_warm_dr_eyewall = np.asarray(slope_warm_dr_eyewall)
slope_nw_dr_eyewall = np.asarray(slope_nw_dr_eyewall)
slope_dm_dr_eyewall = np.asarray(slope_dm_dr_eyewall)
...
for i in range(ku_ul_eyewall.shape[0]):
    ...
    slope_ul_eyewall_nw = stats.mstats.linregress(nw_ul_eyewall_warm[i,:],freezing_ul_eyewall[i,:])[0]
    slope_nw_ul_eyewall.append(slope_ul_eyewall_nw)


    slope_ul_eyewall_dm = stats.mstats.linregress(dm_ul_eyewall_warm[i,:],freezing_ul_eyewall[i,:])[0]
    slope_dm_ul_eyewall.append(slope_ul_eyewall_dm)


slope_warm_ul_eyewall = np.asarray(slope_warm_ul_eyewall)
slope_nw_ul_eyewall = np.asarray(slope_nw_ul_eyewall)
slope_dm_ul_eyewall = np.asarray(slope_dm_ul_eyewall)
...
for i in range(ku_ur_eyewall.shape[0]):
    ...
    slope_ur_eyewall_nw = stats.mstats.linregress(nw_ur_eyewall_warm[i,:],freezing_ur_eyewall[i,:])[0]
    slope_nw_ur_eyewall.append(slope_ur_eyewall_nw)


    slope_ur_eyewall_dm = stats.mstats.linregress(dm_ur_eyewall_warm[i,:],freezing_ur_eyewall[i,:])[0]
    slope_dm_ur_eyewall.append(slope_ur_eyewall_dm)


slope_warm_ur_eyewall = np.asarray(slope_warm_ur_eyewall)
slope_nw_ur_eyewall = np.asarray(slope_nw_ur_eyewall)
slope_dm_ur_eyewall = np.asarray(slope_dm_ur_eyewall)
...
slope_warm_dl_eyewall_file = np.save('1_slope_warm_dl_eyewall_NIND.npy', slope_warm_dl_eyewall, allow_pickle = True)
slope_warm_dr_eyewall_file = np.save('1_slope_warm_dr_eyewall_NIND.npy', slope_warm_dr_eyewall, allow_pickle = True)
slope_warm_ur_eyewall_file = np.save('1_slope_warm_ur_eyewall_NIND.npy', slope_warm_ur_eyewall, allow_pickle = True)
slope_warm_ul_eyewall_file = np.save('1_slope_warm_ul_eyewall_NIND.npy', slope_warm_ul_eyewall, allow_pickle = True)
...
top_dl_eyewall_file =  np.save('1_top_dl_eyewall_NIND.npy', top_dl_eyewall, allow_pickle = True)
top_dr_eyewall_file =  np.save('1_top_dr_eyewall_NIND.npy', top_dr_eyewall, allow_pickle = True)
top_ul_eyewall_file =  np.save('1_top_ul_eyewall_NIND.npy', top_ul_eyewall, allow_pickle = True)
top_ur_eyewall_file =  np.save('1_top_ur_eyewall_NIND.npy', top_ur_eyewall, allow_pickle = True)
...
slope_ice_dl_eyewall_file = np.save('1_slope_ice_dl_eyewall_NIND.npy', slope_ice_dl_eyewall, allow_pickle = True)
slope_ice_dr_eyewall_file = np.save('1_slope_ice_dr_eyewall_NIND.npy', slope_ice_dr_eyewall, allow_pickle = True)
slope_ice_ur_eyewall_file = np.save('1_slope_ice_ur_eyewall_NIND.npy', slope_ice_ur_eyewall, allow_pickle = True)
slope_ice_ul_eyewall_file = np.save('1_slope_ice_ul_eyewall_NIND.npy', slope_ice_ul_eyewall, allow_pickle = True)
