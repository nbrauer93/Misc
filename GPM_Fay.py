...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 14 22:47:12 2020
...
file = '2A.GPM.DPR.V8-20180723.20200710-S002214-E015446.036159.V06A.HDF5'
...
ind1 = np.where((lon[:,0]>=-78)) #Where are the DPR lons >= -100
ind2 = np.where((lon[:,0])<=-73) #Where are lons <= -85
...
plt.title(r'GPM Overpass 7/10 0022-0154 UTC $D_{M}$ ', size = 20)
...
plt.xlabel('Along Track Distance (km)', size = 20)
plt.ylabel('Altitude (km)', size = 20)
plt.title(r'GPM Overpass 7/10 0022-0154 UTC $N_{W}$ ', size = 20)
plt.xlim(dist[0],dist[1])
plt.ylim(0,15)
...
plt.xlabel('Along Track Distance (km)', size = 20)
plt.ylabel('Altitude (km)', size = 20)
plt.title(r'GPM Overpass 7/10 0022-0154 UTC Ku-Band ', size = 20)
#plt.xlim(300,450)
plt.xlim(dist[0], dist[1])
plt.ylim(0,15)
...
xlim = np.array([-80,-72]); ylim = np.array([35,41])
...
plt.title('GPM Overpass 7/10 0022-0154 UTC Ku-Band', size = 20)
