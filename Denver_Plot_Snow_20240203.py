...
file_z = 'KFTG_V06_20240203_220205.nc'
...
for file in range(len(times_ordered)):
    ...
    plt.title(r'KFTG 02/03 ' + time_array_sort[file] + ' UTC' + ' $0.5^{o} Z_{H}$', size = 40)
    plt.savefig(time_array_sort[file] + ".png", dpi = 300)
    #plt.show()
